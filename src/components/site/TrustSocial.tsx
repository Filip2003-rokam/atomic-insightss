    ...
    <section className="py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="mt-20 grid lg:grid-cols-3 gap-6">
          {/* featured */}
          <div className="lg:col-span-3 xl:col-span-3 rounded-3xl bg-brand-navy text-white p-8 sm:p-12 relative overflow-hidden">
            <div
              aria-hidden
          ...
          {testimonials.map((t) => (
            <div key={t.name} className="rounded-2xl border border-border bg-white p-6 sm:p-7">

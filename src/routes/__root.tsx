...
import markAsset from "../assets/atomic-mark.svg.asset.json";
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Atomic Insights · Money movement for RIAs and family offices" },
      {
        ...
        content:
          "Faster, more accurate money movement for RIAs and family offices. Wires, capital calls, bill pay, cash management, and reconciliation in one platform.",
      },
    ...
    links: [
      ...
      { rel: "icon", type: "image/svg+xml", href: markAsset.url },
    ],
  }),
